...
namespace netOnvifCore.Receiver
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.onvif.org/ver10/receiver/wsdl", ConfigurationName="netOnvifCore.Receiver.ReceiverPort")]
    public interface ReceiverPort
    {
        ...
        System.Threading.Tasks.Task<netOnvifCore.Receiver.Capabilities> GetServiceCapabilitiesAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.onvif.org/ver10/receiver/wsdl/GetReceivers", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<netOnvifCore.Receiver.GetReceiversResponse> GetReceiversAsync(netOnvifCore.Receiver.GetReceiversRequest request);
        ...
        System.Threading.Tasks.Task<netOnvifCore.Receiver.Receiver> GetReceiverAsync(string ReceiverToken);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.onvif.org/ver10/receiver/wsdl/CreateReceiver", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="Receiver")]
        System.Threading.Tasks.Task<netOnvifCore.Receiver.Receiver> CreateReceiverAsync(netOnvifCore.Receiver.ReceiverConfiguration Configuration);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task ConfigureReceiverAsync(string ReceiverToken, netOnvifCore.Receiver.ReceiverConfiguration Configuration);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.onvif.org/ver10/receiver/wsdl/SetReceiverMode", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task SetReceiverModeAsync(string ReceiverToken, netOnvifCore.Receiver.ReceiverMode Mode);
        ...
        System.Threading.Tasks.Task<netOnvifCore.Receiver.ReceiverStateInformation> GetReceiverStateAsync(string ReceiverToken);
    }
    ...
    public partial class GetReceiversResponse
    {
        ...
        public netOnvifCore.Receiver.Receiver[] Receivers;
        
        public GetReceiversResponse()
        {
        }
        
        public GetReceiversResponse(netOnvifCore.Receiver.Receiver[] Receivers)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface ReceiverPortChannel : netOnvifCore.Receiver.ReceiverPort, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class ReceiverPortClient : System.ServiceModel.ClientBase<netOnvifCore.Receiver.ReceiverPort>, netOnvifCore.Receiver.ReceiverPort
    {
        ...
        public System.Threading.Tasks.Task<netOnvifCore.Receiver.Capabilities> GetServiceCapabilitiesAsync()
        {
            return base.Channel.GetServiceCapabilitiesAsync();
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<netOnvifCore.Receiver.GetReceiversResponse> netOnvifCore.Receiver.ReceiverPort.GetReceiversAsync(netOnvifCore.Receiver.GetReceiversRequest request)
        {
            return base.Channel.GetReceiversAsync(request);
        }
        
        public System.Threading.Tasks.Task<netOnvifCore.Receiver.GetReceiversResponse> GetReceiversAsync()
        {
            netOnvifCore.Receiver.GetReceiversRequest inValue = new netOnvifCore.Receiver.GetReceiversRequest();
            return ((netOnvifCore.Receiver.ReceiverPort)(this)).GetReceiversAsync(inValue);
        }
        
        public System.Threading.Tasks.Task<netOnvifCore.Receiver.Receiver> GetReceiverAsync(string ReceiverToken)
        {
            return base.Channel.GetReceiverAsync(ReceiverToken);
        }
        
        public System.Threading.Tasks.Task<netOnvifCore.Receiver.Receiver> CreateReceiverAsync(netOnvifCore.Receiver.ReceiverConfiguration Configuration)
        {
        ...
        public System.Threading.Tasks.Task ConfigureReceiverAsync(string ReceiverToken, netOnvifCore.Receiver.ReceiverConfiguration Configuration)
        {
            return base.Channel.ConfigureReceiverAsync(ReceiverToken, Configuration);
        }
        
        public System.Threading.Tasks.Task SetReceiverModeAsync(string ReceiverToken, netOnvifCore.Receiver.ReceiverMode Mode)
        {
            return base.Channel.SetReceiverModeAsync(ReceiverToken, Mode);
        }
        
        public System.Threading.Tasks.Task<netOnvifCore.Receiver.ReceiverStateInformation> GetReceiverStateAsync(string ReceiverToken)
        {
